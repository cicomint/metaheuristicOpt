...
#' \item Check termination criteria, if not meet, back to Update Ants Position steps. 
#'       Else, return the elite as the optimal solution for given problem.
#'} 
#' 
...
#' best.variable <- ALO(sphere, optimType="MIN", numVar, numPopulation=20, 
