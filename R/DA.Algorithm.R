...
#' best.variable <- DA(sphere, optimType="MIN", numVar, numPopulation=20, 
...
#' 
#' @references
#' Seyedali Mirjalili. 2016. Dragonfly algorithm: a new meta-heuristic optimization 
#' technique for solving single-objective, discrete, and multi-objective problems. 
#' Neural Comput. Appl. 27, 4 (May 2016), 1053-1073. 
